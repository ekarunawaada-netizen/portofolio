          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <div className="md:col-span-8 group relative overflow-hidden rounded-lg bg-surface-container-lowest min-h-[500px] flex flex-col justify-end">
              ...
              <div className="relative z-10 p-10">
                ...
                <div className="flex flex-wrap gap-4">
                  <button
                    onClick={() => openModal("Bangun Rumah Baru")}
                    className="bg-on-tertiary-container text-white px-8 py-4 font-headline font-bold uppercase tracking-wider text-sm hover:brightness-110 transition-all active:scale-95"
                  >
                    Minta Penawaran
                  </button>
            ...
            <div className="md:col-span-4 group relative overflow-hidden rounded-lg bg-surface-container min-h-[500px] flex flex-col">
              ...
              <div className="p-8 flex-1 flex flex-col justify-between">
                ...
                <button
                  onClick={() => openModal("Renovasi & Perbaikan")}
                  className="w-full border-b-2 border-primary py-3 flex justify-between items-center hover:bg-primary hover:text-white hover:px-4 transition-all duration-300 group/btn"
                >
            ...
            <div className="md:col-span-5 group relative overflow-hidden rounded-lg bg-surface-container-lowest min-h-[400px] flex flex-col border-none">
              ...
              <div className="relative z-10 p-10 flex flex-col h-full">
                ...
                <div className="mt-auto">
                  <button
                    onClick={() => openModal("Pemasangan Keramik & Granit")}
                    className="bg-primary text-white px-6 py-3 font-headline font-bold uppercase text-xs tracking-widest hover:bg-primary-container transition-colors active:scale-95"
                  >
                    Minta Penawaran
                  </button>
                </div>
            ...
            <div className="md:col-span-7 group relative overflow-hidden rounded-lg bg-primary min-h-[400px] flex items-center">
              <div className="grid grid-cols-1 md:grid-cols-2 h-full w-full">
                <div className="p-10 flex flex-col justify-center order-2 md:order-1">
                  ...
                  <button
                    onClick={() => openModal("Pengecatan & Finishing")}
                    className="border-2 border-on-tertiary-container text-on-tertiary-container px-6 py-3 font-headline font-bold uppercase text-xs tracking-widest hover:bg-on-tertiary-container hover:text-white transition-all w-fit active:scale-95"
                  >
                    Minta Penawaran
                  </button>
                </div>
        ...
        <section className="max-w-7xl mx-auto px-8 mt-32">
          <div className="bg-surface-container-lowest p-12 md:p-20 relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-12">
            ...
            <div className="relative z-10 flex flex-col gap-4 w-full md:w-auto">
              ...
              <button
                onClick={() => openModal("Konsultasi Umum")}
                className="border-2 border-primary text-primary px-10 py-4 font-headline font-bold uppercase tracking-widest text-sm hover:bg-primary hover:text-white transition-all text-center"
              >
